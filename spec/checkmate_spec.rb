...
describe Check do
  ...
  describe '#check?' do
    ...
    context 'When board is in a complex stalemate' do
       it 'Returns false' do
         chessboard.board = {
           8 => { 1 => Square.new(:light_white),
                  2 => Square.new(:light_red),
           ...
           7 => { 1 => Square.new(:light_red),
                  ...
                  8 => Square.new(Queen.new(:black, 'black'), :light_white) },
 
           6 => { 1 => Square.new(:light_white),
                  2 => Square.new(:light_red),
                  3 => Square.new(:light_white),
                  4 => Square.new(:light_red),
                  5 => Square.new(Queen.new(:white, 'white'), :light_white),
                  6 => Square.new(Pawn.new(:black, 'black'), :light_red),
                  7 => Square.new(King.new(:black, 'black'), :light_white),
                  8 => Square.new(Rook.new(:black, 'black'), :light_red) },
         ...
         print "\n"
         chessboard.display_board
         king = board[6][7].piece
         board[5][8].piece.moved = true
         result = check.check?(board, king, 'white')
         expect(result).to eq(false)
       end
     end
  ...
  describe '#stalemate?' do
    context 'When black cannot make a legal move, but is not in check' do
      it 'Returns true' do
        chessboard.board = {
          8 => { 1 => Square.new(:light_white),
                 2 => Square.new(:light_red),
          ...
          6 => { 1 => Square.new(:light_white),
                 ...
                 5 => Square.new(:light_white),
                 6 => Square.new(:light_red),
                 7 => Square.new(Rook.new(:white, 'white'), :light_white),
                 8 => Square.new(King.new(:white, 'white'), :light_red) },
        ...
        chessboard.display_board
        king = board[8][8].piece
        result = check.stalemate?(board, king, 'black', 'white')
        expect(result).to eq(true)
      end
    end
